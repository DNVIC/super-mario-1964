...
static const Vtx dirt_seg3_vertex_0302BDC8[] = {
    {{{  -101,    -60,      0}, 0, {  -130,    467}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   102,    -60,      0}, 0, {   599,    467}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{     0,     92,      0}, 0, {   234,    -81}, {0x2a, 0x2a, 0x2a,  0xff}}},
};
...
static const Vtx dirt_seg3_vertex_0302C098[] = {
    {{{   -10,      0,     10}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0x00}}},
    {{{    10,      0,     10}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0x00}}},
    {{{     0,      0,    -10}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0x00}}},
};

// 0x0302C0C8
static const Vtx dirt_seg3_vertex_0302C0C8[] = {
    {{{   -10,     10,      0}, 0, {     0,      0}, {0xaa, 0xaa, 0xaa,  0xff}}},
    {{{    10,     10,      0}, 0, {     0,      0}, {0xaa, 0xaa, 0xaa,  0xff}}},
    {{{     0,    -10,      0}, 0, {     0,      0}, {0xaa, 0xaa, 0xaa,  0xff}}},
};

// 0x0302C0F8
static const Vtx dirt_seg3_vertex_0302C0F8[] = {
    {{{     0,     -8,      0}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0x00}}},
    {{{   -32,     80,      0}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0x00}}},
    {{{    32,     80,      0}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0x00}}},
    {{{   -52,     28,      0}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -116,     80,      0}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   -84,    -52,      0}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{    52,     28,      0}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{    84,    -52,      0}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   116,     80,      0}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{     0,    160,      0}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
};

// 0x0302C198
static const Vtx dirt_seg3_vertex_0302C198[] = {
    {{{     0,     -8,      0}, 0, {     0,      0}, {0xaa, 0xaa, 0xaa,  0xff}}},
    {{{   -32,     80,      0}, 0, {     0,      0}, {0xaa, 0xaa, 0xaa,  0xff}}},
    {{{    32,     80,      0}, 0, {     0,      0}, {0xaa, 0xaa, 0xaa,  0xff}}},
    {{{   -52,     28,      0}, 0, {     0,      0}, {0xaa, 0xaa, 0xaa,  0xff}}},
    {{{  -116,     80,      0}, 0, {     0,      0}, {0xaa, 0xaa, 0xaa,  0xff}}},
    {{{   -84,    -52,      0}, 0, {     0,      0}, {0xaa, 0xaa, 0xaa,  0xff}}},
    {{{    52,     28,      0}, 0, {     0,      0}, {0xaa, 0xaa, 0xaa,  0xff}}},
    {{{    84,    -52,      0}, 0, {     0,      0}, {0xaa, 0xaa, 0xaa,  0xff}}},
    {{{   116,     80,      0}, 0, {     0,      0}, {0xaa, 0xaa, 0xaa,  0xff}}},
    {{{     0,    160,      0}, 0, {     0,      0}, {0xaa, 0xaa, 0xaa,  0xff}}},
};
