...
static const Vtx star_seg3_vertex_0302B6F0[] = {
    {{{     0,      8,    -89}, 0, {     0,      0}, {0x2e, 0x2e, 0x2e,  0xff}}},
    {{{   190,   -201,      0}, 0, {     0,      0}, {0x53, 0x53, 0x53,  0xff}}},
    {{{     0,   -129,      0}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   146,    -42,      0}, 0, {     0,      0}, {0x76, 0x76, 0x76,  0xff}}},
    {{{     0,      8,     90}, 0, {     0,      0}, {0x2c, 0x2c, 0x2c,  0xff}}},
    {{{   257,     84,      0}, 0, {     0,      0}, {0x3a, 0x3a, 0x3a,  0xff}}},
    {{{  -145,    -42,      0}, 0, {     0,      0}, {0x79, 0x79, 0x79,  0xff}}},
    {{{  -189,   -201,      0}, 0, {     0,      0}, {0x6f, 0x6f, 0x6f,  0xff}}},
    {{{  -256,     84,      0}, 0, {     0,      0}, {0x4a, 0x4a, 0x4a,  0xff}}},
    {{{     0,    246,      0}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    96,     99,      0}, 0, {     0,      0}, {0x39, 0x39, 0x39,  0xff}}},
    {{{   -95,     99,      0}, 0, {     0,      0}, {0x66, 0x66, 0x66,  0xff}}},
};
...
static const Vtx star_seg3_vertex_0302B920[] = {
    {{{    67,     86,     63}, 0, {   990,      0}, {0x38, 0x38, 0x38,  0xff}}},
    {{{     0,    -27,     96}, 0, {     0,    990}, {0x38, 0x38, 0x38,  0xff}}},
    {{{    67,    -29,     83}, 0, {   990,    990}, {0x38, 0x38, 0x38,  0xff}}},
    {{{     0,     89,     76}, 0, {     0,      0}, {0x38, 0x38, 0x38,  0xff}}},
    {{{     0,     89,     76}, 0, {   990,      0}, {0x7d, 0x7d, 0x7d,  0xff}}},
    {{{   -66,    -29,     83}, 0, {     0,    990}, {0x7d, 0x7d, 0x7d,  0xff}}},
    {{{     0,    -27,     96}, 0, {   990,    990}, {0x7d, 0x7d, 0x7d,  0xff}}},
    {{{     0,     89,     76}, 0, {   990,      0}, {0x7d, 0x7d, 0x7d,  0xff}}},
    {{{   -66,     86,     63}, 0, {     0,      0}, {0x7d, 0x7d, 0x7d,  0xff}}},
    {{{   -66,    -29,     83}, 0, {     0,    990}, {0x7d, 0x7d, 0x7d,  0xff}}},
};
