...
static const Vtx bbh_seg7_vertex_0700D368[] = {
    {{{ -1740,   1536,   2550}, 0, {   990,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{ -1330,   1536,   2550}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{ -1330,   1126,   2550}, 0, {     0,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{ -1740,   1126,   2550}, 0, {   990,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{ -1740,    614,   2550}, 0, {   990,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{ -1330,    614,   2550}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{ -1330,    205,   2550}, 0, {     0,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{ -1740,    205,   2550}, 0, {   990,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -613,    614,   2038}, 0, {   990,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -204,    614,   2038}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -204,    205,   2038}, 0, {     0,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -613,    205,   2038}, 0, {   990,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
};
