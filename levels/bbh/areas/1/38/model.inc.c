...
static const Vtx bbh_seg7_vertex_0701ED88[] = {
    {{{  1331,    563,   2161}, 0, {   990,      0}, {0x55, 0x55, 0x55,  0x9a}}},
    {{{   922,    154,   2161}, 0, {     0,    990}, {0x55, 0x55, 0x55,  0x9a}}},
    {{{  1331,    154,   2161}, 0, {   990,    990}, {0x55, 0x55, 0x55,  0x9a}}},
    {{{   922,    563,   2161}, 0, {     0,      0}, {0x55, 0x55, 0x55,  0x9a}}},
    {{{     0,    154,   2161}, 0, {     0,    990}, {0x55, 0x55, 0x55,  0x9a}}},
    {{{   410,    154,   2161}, 0, {   990,    990}, {0x55, 0x55, 0x55,  0x9a}}},
    {{{   410,    563,   2161}, 0, {   990,      0}, {0x55, 0x55, 0x55,  0x9a}}},
    {{{     0,    563,   2161}, 0, {     0,      0}, {0x55, 0x55, 0x55,  0x9a}}},
};

// 0x0701EE08 - 0x0701EE48
static const Vtx bbh_seg7_vertex_0701EE08[] = {
    {{{ -1740,    717,  -1648}, 0, {   990,      0}, {0x72, 0x72, 0x72,  0x9a}}},
    {{{ -1381,    717,  -1648}, 0, {     0,      0}, {0x72, 0x72, 0x72,  0x9a}}},
    {{{ -1381,      0,  -1648}, 0, {     0,   2012}, {0x72, 0x72, 0x72,  0x9a}}},
    {{{ -1740,      0,  -1648}, 0, {   990,   2012}, {0x72, 0x72, 0x72,  0x9a}}},
};
