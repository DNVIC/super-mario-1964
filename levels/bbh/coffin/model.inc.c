...
static const Vtx bbh_seg7_vertex_07020380[] = {
    {{{    58,      0,      0}, 0, {   990,    479}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   -57,     77,      0}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   -57,      0,      0}, 0, {     0,    479}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    58,     77,      0}, 0, {   990,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   115,      0,   -306}, 0, {  2006,    479}, {0x31, 0x31, 0x31,  0xff}}},
    {{{    58,     77,      0}, 0, {     0,      0}, {0x31, 0x31, 0x31,  0xff}}},
    {{{    58,      0,      0}, 0, {     0,    479}, {0x31, 0x31, 0x31,  0xff}}},
    {{{   115,     77,   -306}, 0, {  2006,      0}, {0x31, 0x31, 0x31,  0xff}}},
    {{{    58,      0,   -460}, 0, {   990,    479}, {0x6e, 0x6e, 0x6e,  0xff}}},
    {{{   115,     77,   -306}, 0, {   -30,      0}, {0x6e, 0x6e, 0x6e,  0xff}}},
    {{{   115,      0,   -306}, 0, {   -30,    479}, {0x6e, 0x6e, 0x6e,  0xff}}},
    {{{    58,     77,   -460}, 0, {   990,      0}, {0x6e, 0x6e, 0x6e,  0xff}}},
    {{{   -57,      0,   -460}, 0, {     0,    479}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{    58,     77,   -460}, 0, {   990,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{    58,      0,   -460}, 0, {   990,    479}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   -57,     77,   -460}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
};

// 0x07020480 - 0x07020500
static const Vtx bbh_seg7_vertex_07020480[] = {
    {{{  -114,      0,   -306}, 0, {   -30,    479}, {0x74, 0x74, 0x74,  0xff}}},
    {{{  -114,     77,   -306}, 0, {   -30,      0}, {0x74, 0x74, 0x74,  0xff}}},
    {{{   -57,     77,   -460}, 0, {   990,      0}, {0x74, 0x74, 0x74,  0xff}}},
    {{{   -57,      0,   -460}, 0, {   990,    479}, {0x74, 0x74, 0x74,  0xff}}},
    {{{   -57,      0,      0}, 0, {     0,    479}, {0x34, 0x34, 0x34,  0xff}}},
    {{{  -114,     77,   -306}, 0, {  2006,      0}, {0x34, 0x34, 0x34,  0xff}}},
    {{{  -114,      0,   -306}, 0, {  2006,    479}, {0x34, 0x34, 0x34,  0xff}}},
    {{{   -57,     77,      0}, 0, {     0,      0}, {0x34, 0x34, 0x34,  0xff}}},
};

// 0x07020500 - 0x07020560
static const Vtx bbh_seg7_vertex_07020500[] = {
    {{{   -57,      0,   -460}, 0, {  3034,   1117}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{    58,      0,   -460}, 0, {  3034,    351}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   115,      0,   -306}, 0, {  2012,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -114,      0,   -306}, 0, {  2012,   1500}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   -57,      0,      0}, 0, {     0,   1117}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{    58,      0,      0}, 0, {     0,    351}, {0x2b, 0x2b, 0x2b,  0xff}}},
};

// 0x07020560 - 0x070205C0
static const Vtx bbh_seg7_vertex_07020560[] = {
    {{{   -57,     77,      0}, 0, {   224,   2012}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   115,     77,   -306}, 0, {   990,    648}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -114,     77,   -306}, 0, {     0,    648}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    58,     77,      0}, 0, {   734,   2012}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    58,     77,   -460}, 0, {   734,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   -57,     77,   -460}, 0, {   224,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
};
