...
static const Vtx bbh_seg7_vertex_0701F0F8[] = {
    {{{   154,    614,   -101}, 0, {  3034,   2010}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -153,    614,   -101}, 0, { -3096,   2010}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -153,    614,    102}, 0, { -3096,   6098}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   154,    614,    102}, 0, {  3034,   6098}, {0x2a, 0x2a, 0x2a,  0xff}}},
};

// 0x0701F138 - 0x0701F238
static const Vtx bbh_seg7_vertex_0701F138[] = {
    {{{   154,      0,   -101}, 0, {   990,   2012}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -153,      0,   -101}, 0, {     0,   2012}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   154,    614,   -101}, 0, {   990,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   154,    614,    102}, 0, {   990,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -153,      0,    102}, 0, {     0,   2012}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   154,      0,    102}, 0, {   990,   2012}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -153,    614,    102}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -153,      0,   -101}, 0, {   308,   2012}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -153,    614,    102}, 0, {   990,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -153,    614,   -101}, 0, {   308,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -153,      0,    102}, 0, {   990,   2012}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   154,      0,   -101}, 0, {   308,   2012}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   154,    614,   -101}, 0, {   308,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   154,    614,    102}, 0, {   990,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   154,      0,    102}, 0, {   990,   2012}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -153,    614,   -101}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
};
