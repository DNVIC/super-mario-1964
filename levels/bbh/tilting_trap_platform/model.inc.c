...
static const Vtx bbh_seg7_vertex_0701F390[] = {
    {{{   307,   -101,    256}, 0, {   698,    260}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -306,   -101,    256}, 0, {   260,    260}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -306,   -101,   -255}, 0, {   260,    624}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   307,   -101,   -255}, 0, {   698,    624}, {0x2b, 0x2b, 0x2b,  0xff}}},
};

// 0x0701F3D0 - 0x0701F4D0
static const Vtx bbh_seg7_vertex_0701F3D0[] = {
    {{{   307,      0,    256}, 0, {  2522,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   307,   -101,   -255}, 0, {     0,    988}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   307,      0,   -255}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   307,      0,   -255}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -306,   -101,   -255}, 0, {  3034,    992}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -306,      0,   -255}, 0, {  3034,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   307,   -101,   -255}, 0, {     0,    992}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -306,      0,   -255}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -306,   -101,   -255}, 0, {     0,    988}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -306,   -101,    256}, 0, {  2522,    988}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -306,      0,    256}, 0, {  2522,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -306,      0,    256}, 0, {  3034,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -306,   -101,    256}, 0, {  3034,    992}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   307,   -101,    256}, 0, {     0,    992}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   307,      0,    256}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   307,   -101,    256}, 0, {  2522,    988}, {0x2a, 0x2a, 0x2a,  0xff}}},
};

// 0x0701F4D0 - 0x0701F510
static const Vtx bbh_seg7_vertex_0701F4D0[] = {
    {{{   307,      0,   -255}, 0, {  5080,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -306,      0,    256}, 0, {     0,  -5142}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   307,      0,    256}, 0, {     0,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -306,      0,   -255}, 0, {  5076,  -5142}, {0x2a, 0x2a, 0x2a,  0xff}}},
};
