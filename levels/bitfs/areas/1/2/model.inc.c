...
static const Vtx bitfs_seg7_vertex_07002308[] = {
    ...
    {{{ -1125,    307,   -511}, 0, {  3120,   1074}, {0xc2, 0xc2, 0xc2,  0xff}}},
    {{{ -2047,    307,    512}, 0, {  -116,    904}, {0xc2, 0xc2, 0xc2,  0xff}}},
    {{{ -1125,    307,    512}, 0, {  1416,   -628}, {0xc2, 0xc2, 0xc2,  0xff}}},
    {{{ -2047,    307,   -511}, 0, {  1586,   2606}, {0xc2, 0xc2, 0xc2,  0xff}}},
...
static const Vtx bitfs_seg7_vertex_07002488[] = {
    {{{ -2047,    307,    512}, 0, {   990,      0}, {0x6b, 0x6b, 0x6b,  0xff}}},
    {{{ -2047,    307,   -511}, 0, { -2414,      0}, {0x6b, 0x6b, 0x6b,  0xff}}},
    {{{ -2047,      0,   -511}, 0, { -2414,    990}, {0x6b, 0x6b, 0x6b,  0xff}}},
    {{{ -2047,      0,    512}, 0, {   990,    990}, {0x6b, 0x6b, 0x6b,  0xff}}},
    {{{ -1125,    307,    512}, 0, {     0,      0}, {0x6b, 0x6b, 0x6b,  0xff}}},
    {{{ -1125,      0,   -511}, 0, {  3374,    990}, {0x6b, 0x6b, 0x6b,  0xff}}},
    {{{ -1125,    307,   -511}, 0, {  3374,      0}, {0x6b, 0x6b, 0x6b,  0xff}}},
    {{{ -1125,      0,    512}, 0, {     0,    990}, {0x6b, 0x6b, 0x6b,  0xff}}},
    {{{ -2047,      0,    512}, 0, {     0,    990}, {0x8c, 0x8c, 0x8c,  0xff}}},
    {{{ -1125,    307,    512}, 0, {  3034,      0}, {0x8c, 0x8c, 0x8c,  0xff}}},
    {{{ -2047,    307,    512}, 0, {     0,      0}, {0x8c, 0x8c, 0x8c,  0xff}}},
    {{{ -1125,      0,    512}, 0, {  3034,    990}, {0x8c, 0x8c, 0x8c,  0xff}}},
    {{{ -1125,      0,   -511}, 0, {     0,    990}, {0x8c, 0x8c, 0x8c,  0xff}}},
    {{{ -2047,    307,   -511}, 0, {  3034,      0}, {0x8c, 0x8c, 0x8c,  0xff}}},
    {{{ -1125,    307,   -511}, 0, {     0,      0}, {0x8c, 0x8c, 0x8c,  0xff}}},
    {{{ -2047,      0,   -511}, 0, {  3034,    990}, {0x8c, 0x8c, 0x8c,  0xff}}},
};
...
static const Vtx bitfs_seg7_vertex_07002688[] = {
    {{{  -101,     51,      0}, 0, {-11920,   5562}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{   922,     51,      0}, 0, { -5106,   3006}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{  -101,      0,    -50}, 0, {-12430,   5690}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{   870,      0,    -50}, 0, { -5958,   3262}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{  1157,   -163,    -50}, 0, { -4050,   2546}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{  1208,   -112,      0}, 0, { -3198,   2290}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{  1823,   -112,      0}, 0, {   888,    760}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{  1874,   -163,    -50}, 0, {   718,    760}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{  2130,     41,     10}, 0, {  3034,      0}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{  2181,     -9,    -40}, 0, {  2864,      0}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{  -101,      0,     51}, 0, {-11408,   5434}, {0x75, 0x75, 0x75,  0xff}}},
    {{{   870,      0,     51}, 0, { -4936,   3006}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  -101,     51,      0}, 0, {-11920,   5562}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  1208,   -112,      0}, 0, { -3198,   2290}, {0x75, 0x75, 0x75,  0xff}}},
    {{{   922,     51,      0}, 0, { -5106,   3006}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  1157,   -163,     51}, 0, { -3028,   2290}, {0x75, 0x75, 0x75,  0xff}}},
};

// 0x07002788 - 0x070027E8
static const Vtx bitfs_seg7_vertex_07002788[] = {
    {{{  1157,   -163,     51}, 0, { -3028,   2290}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  1874,   -163,     51}, 0, {  1740,    504}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  1208,   -112,      0}, 0, { -3198,   2290}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  1823,   -112,      0}, 0, {   888,    760}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  2181,     -9,     61}, 0, {  3886,   -288}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  2130,     41,     10}, 0, {  3034,      0}, {0x75, 0x75, 0x75,  0xff}}},
};
