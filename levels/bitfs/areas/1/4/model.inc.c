...
static const Vtx bitfs_seg7_vertex_07003780[] = {
    {{{  1434,    -50,     51}, 0, { 25348,  -8336}, {0xac, 0xac, 0xac,  0xff}}},
    {{{  1434,    -50,    -50}, 0, { 24326,  -8080}, {0xac, 0xac, 0xac,  0xff}}},
    {{{  1331,      0,      0}, 0, { 24156,  -7952}, {0xac, 0xac, 0xac,  0xff}}},
    {{{  -297,   -302,     -9}, 0, { 13212,  -3862}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{     0,      0,      0}, 0, { 15298,  -4632}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{    51,    -50,    -50}, 0, { 15128,  -4632}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{  1434,    -50,    -50}, 0, { 24326,  -8080}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{  1331,      0,      0}, 0, { 24156,  -7952}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{  -246,   -353,    -60}, 0, { 13042,  -3862}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{  -716,   -306,      0}, 0, { 10528,  -2842}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{  -767,   -357,    -50}, 0, {  9678,  -2588}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{ -1125,      0,      0}, 0, {  7804,  -1820}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{ -1177,    -50,    -50}, 0, {  6952,  -1566}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{ -1842,      0,      0}, 0, {  3034,      0}, {0xa9, 0xa9, 0xa9,  0xff}}},
    {{{ -1791,    -50,    -50}, 0, {  2864,      0}, {0xa9, 0xa9, 0xa9,  0xff}}},
};

// 0x07003870 - 0x07003930
static const Vtx bitfs_seg7_vertex_07003870[] = {
    {{{    51,    -50,     51}, 0, { 16150,  -4886}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  1434,    -50,     51}, 0, { 25348,  -8336}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  1331,      0,      0}, 0, { 24156,  -7952}, {0x75, 0x75, 0x75,  0xff}}},
    {{{     0,      0,      0}, 0, { 15298,  -4632}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  -246,   -353,     41}, 0, { 14064,  -4118}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  -297,   -302,     -9}, 0, { 13212,  -3862}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  -716,   -306,      0}, 0, { 10528,  -2842}, {0x75, 0x75, 0x75,  0xff}}},
    {{{  -767,   -357,     51}, 0, { 10700,  -2842}, {0x75, 0x75, 0x75,  0xff}}},
    {{{ -1177,    -50,     51}, 0, {  7974,  -1820}, {0x75, 0x75, 0x75,  0xff}}},
    {{{ -1125,      0,      0}, 0, {  7804,  -1820}, {0x75, 0x75, 0x75,  0xff}}},
    {{{ -1791,    -50,     51}, 0, {  3886,   -288}, {0x75, 0x75, 0x75,  0xff}}},
    {{{ -1842,      0,      0}, 0, {  3034,      0}, {0x75, 0x75, 0x75,  0xff}}},
};
