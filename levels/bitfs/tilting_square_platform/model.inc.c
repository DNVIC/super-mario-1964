...
static const Vtx bitfs_seg7_vertex_0700FBA8[] = {
    {{{   307,    307,   -306}, 0, {  2420,    990}, {0x70, 0x70, 0x70,  0xff}}},
    {{{  -306,    307,    307}, 0, {     0,    990}, {0x70, 0x70, 0x70,  0xff}}},
    {{{   307,    307,    307}, 0, {  1194,   -236}, {0x70, 0x70, 0x70,  0xff}}},
    {{{  -306,    307,   -306}, 0, {  1194,   2214}, {0x70, 0x70, 0x70,  0xff}}},
};

// 0x0700FBE8 - 0x0700FC88
static const Vtx bitfs_seg7_vertex_0700FBE8[] = {
    {{{   307,    307,   -306}, 0, {   478,   1498}, {0x55, 0x55, 0x55,  0xff}}},
    {{{     0,      0,      0}, 0, {     0,    990}, {0x55, 0x55, 0x55,  0xff}}},
    {{{  -306,    307,   -306}, 0, {   478,    480}, {0x55, 0x55, 0x55,  0xff}}},
    {{{   307,    307,    307}, 0, {  -540,   1498}, {0x55, 0x55, 0x55,  0xff}}},
    {{{  -306,    307,    307}, 0, {  -542,    480}, {0x55, 0x55, 0x55,  0xff}}},
    {{{  -306,    307,    307}, 0, {  -542,    480}, {0x32, 0x32, 0x32,  0xff}}},
    {{{  -306,    307,   -306}, 0, {   478,    480}, {0x32, 0x32, 0x32,  0xff}}},
    {{{     0,      0,      0}, 0, {     0,    990}, {0x32, 0x32, 0x32,  0xff}}},
    {{{   307,    307,   -306}, 0, {   478,   1498}, {0x32, 0x32, 0x32,  0xff}}},
    {{{   307,    307,    307}, 0, {  -540,   1498}, {0x32, 0x32, 0x32,  0xff}}},
};
