...
static const Vtx bowser_3_seg7_vertex_070029D8[] = {
    {{{ -1497,  -1852,   2050}, 0, {   580,    338}, {0x96, 0x96, 0x96,  0xff}}},
    {{{     0,  -2364,   1262}, 0, {  1366,  -1156}, {0x96, 0x96, 0x96,  0xff}}},
    {{{     0,  -1340,   3277}, 0, {  -644,  -1156}, {0x96, 0x96, 0x96,  0xff}}},
    {{{ -1497,  -1852,   2050}, 0, {   580,    338}, {0x98, 0x98, 0x98,  0xff}}},
    {{{     0,  -1340,   3277}, 0, {  -644,  -1156}, {0x98, 0x98, 0x98,  0xff}}},
    {{{ -1945,  -1340,   2662}, 0, {     0,    786}, {0x98, 0x98, 0x98,  0xff}}},
};
...
static const Vtx bowser_3_seg7_vertex_07002A78[] = {
    {{{     0,  -2364,   1262}, 0, { -1020,   2012}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{     0,    307,   1262}, 0, { -1020,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{     0,  -1340,   3277}, 0, {   990,   2012}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{     0,  -1340,   3277}, 0, {  3800,   1816}, {0x71, 0x71, 0x71,  0xff}}},
    {{{ -1945,    307,   2662}, 0, {  2260,    172}, {0x71, 0x71, 0x71,  0xff}}},
    {{{ -1945,  -1340,   2662}, 0, {  2260,   1816}, {0x71, 0x71, 0x71,  0xff}}},
    {{{     0,    307,   3277}, 0, {  3800,    172}, {0x71, 0x71, 0x71,  0xff}}},
    {{{ -1945,    307,   2662}, 0, {   234,      0}, {0x70, 0x70, 0x70,  0xff}}},
    {{{ -1497,    307,   2050}, 0, {   990,      0}, {0x70, 0x70, 0x70,  0xff}}},
    {{{ -1497,  -1852,   2050}, 0, {   990,   2012}, {0x70, 0x70, 0x70,  0xff}}},
    {{{ -1945,  -1340,   2662}, 0, {   234,   2012}, {0x70, 0x70, 0x70,  0xff}}},
    {{{ -1497,    307,   2050}, 0, {  -698,      0}, {0x72, 0x72, 0x72,  0xff}}},
    {{{     0,  -2364,   1262}, 0, {   990,   2012}, {0x72, 0x72, 0x72,  0xff}}},
    {{{ -1497,  -1852,   2050}, 0, {  -698,   2012}, {0x72, 0x72, 0x72,  0xff}}},
    {{{     0,    307,   1262}, 0, {   990,      0}, {0x72, 0x72, 0x72,  0xff}}},
    {{{     0,    307,   3277}, 0, {   990,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
};
