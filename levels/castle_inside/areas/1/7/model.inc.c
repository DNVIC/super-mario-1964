...
static const Vtx inside_castle_seg7_vertex_0702AA98[] = {
    {{{ -1330,   1690,   1526}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -716,   1690,   1526}, 0, {   990,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -716,   1075,   1526}, 0, {   990,   2012}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{ -1330,   1075,   1526}, 0, {     0,   2012}, {0x2b, 0x2b, 0x2b,  0xff}}},
};
