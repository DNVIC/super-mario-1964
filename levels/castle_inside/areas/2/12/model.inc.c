...
static const Vtx inside_castle_seg7_vertex_07051A50[] = {
    {{{     0,   2611,   7130}, 0, {     0,      0}, {0x69, 0x69, 0x69,  0x80}}},
    {{{     0,   2253,   7130}, 0, {     0,      0}, {0x69, 0x69, 0x69,  0x80}}},
    {{{   -50,   2253,   7027}, 0, {     0,      0}, {0x69, 0x69, 0x69,  0x80}}},
    {{{   -50,   2611,   7027}, 0, {     0,      0}, {0x69, 0x69, 0x69,  0x80}}},
    {{{   -50,   2611,   7027}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0x80}}},
    {{{   -50,   2253,   7027}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0x80}}},
    {{{  -357,   2253,   7027}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0x80}}},
    {{{  -357,   2611,   7027}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0x80}}},
    {{{  -357,   2611,   7027}, 0, {     0,      0}, {0x72, 0x72, 0x72,  0x80}}},
    {{{  -357,   2253,   7027}, 0, {     0,      0}, {0x72, 0x72, 0x72,  0x80}}},
    {{{  -409,   2253,   7130}, 0, {     0,      0}, {0x72, 0x72, 0x72,  0x80}}},
    {{{  -409,   2611,   7130}, 0, {     0,      0}, {0x72, 0x72, 0x72,  0x80}}},
};
