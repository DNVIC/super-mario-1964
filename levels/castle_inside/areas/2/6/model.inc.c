...
static const Lights1 inside_castle_seg7_lights_0704A1B8 = gdSPDefLights1(
    0x3e, 0x3e, 0x3e,  
    0xf8, 0xf8, 0xf8,   0x28, 0x28, 0x28
);

// 0x0704A1D0 - 0x0704A290
static const Vtx inside_castle_seg7_vertex_0704A1D0[] = {
    {{{  4332,   1408,   3415}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  4332,   2125,   2647}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  4332,   1408,   2647}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  4332,   2125,   3415}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  4332,   1408,   1008}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  4332,   2125,    240}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  4332,   1408,    240}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  4332,   2125,   1008}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  4332,   1408,   2493}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  4332,   2125,   1162}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  4332,   1408,   1162}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  4332,   2125,   2493}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
};
