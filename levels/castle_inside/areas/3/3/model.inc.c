...
static const Vtx inside_castle_seg7_vertex_0705E328[] = {
    {{{  -101,   -429,   1075}, 0, {   990,   -102}, {0x2b, 0x2b, 0x2b,  0x60}}},
    {{{  -562,   -858,   1075}, 0, {     0,    990}, {0x2b, 0x2b, 0x2b,  0x60}}},
    {{{  -562,   -429,   1075}, 0, {     0,   -102}, {0x2b, 0x2b, 0x2b,  0x60}}},
    {{{  -101,   -858,   1075}, 0, {   990,    990}, {0x2b, 0x2b, 0x2b,  0x60}}},
    {{{  -562,   -858,   1075}, 0, {     0,    990}, {0x2b, 0x2b, 0x2b,  0x60}}},
    {{{  -101,   -858,   1075}, 0, {   990,    990}, {0x2b, 0x2b, 0x2b,  0x60}}},
    {{{  -101,   -858,   1178}, 0, {   990,    990}, {0x2b, 0x2b, 0x2b,  0x60}}},
    {{{  -562,   -858,   1178}, 0, {     0,    990}, {0x2b, 0x2b, 0x2b,  0x60}}},
    {{{  -562,   -460,   1178}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0x60}}},
    {{{  -101,   -858,   1178}, 0, {   990,    990}, {0x2a, 0x2a, 0x2a,  0x60}}},
    {{{  -101,   -460,   1178}, 0, {   990,      0}, {0x2a, 0x2a, 0x2a,  0x60}}},
    {{{  -562,   -858,   1178}, 0, {     0,    990}, {0x2a, 0x2a, 0x2a,  0x60}}},
};
