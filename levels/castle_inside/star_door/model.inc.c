...
static const Vtx inside_castle_seg7_vertex_0703BD40[] = {
    {{{   -76,      0,    -15}, 0, {   478,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   -76,      0,     15}, 0, {   992,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   -76,    256,     15}, 0, {   992,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   -76,    256,    -15}, 0, {  1100,    460}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    79,    256,     15}, 0, {  -650,    240}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    79,    256,    -15}, 0, {  -542,    734}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   -76,    256,     15}, 0, {   990,    -34}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    79,      0,    -15}, 0, {  1234,   -116}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   -76,      0,     15}, 0, {  -174,    868}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   -76,      0,    -15}, 0, {  -604,    498}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{    79,      0,     15}, 0, {  1664,    254}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{    79,      0,     15}, 0, {     0,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    79,      0,    -15}, 0, {   584,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    79,    256,    -15}, 0, {   584,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    79,    256,     15}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   -76,    256,    -15}, 0, {   480,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
};

// 0x0703BE40 - 0x0703BE80
static const Vtx inside_castle_seg7_vertex_0703BE40[] = {
    {{{   -76,      0,     15}, 0, {     0,   2012}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    79,      0,     15}, 0, {   990,   2012}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    79,    256,     15}, 0, {   990,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   -76,    256,     15}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
};

// 0x0703BE80 - 0x0703BEC0
static const Vtx inside_castle_seg7_vertex_0703BE80[] = {
    {{{    79,      0,    -15}, 0, {     0,   2012}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   -76,    256,    -15}, 0, {   990,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{    79,    256,    -15}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   -76,      0,    -15}, 0, {   990,   2012}, {0x2b, 0x2b, 0x2b,  0xff}}},
};
