...
static const Vtx hmc_seg7_vertex_07022EA8[] = {
    {{{    38,     11,     38}, 0, {   990,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    38,     11,    -37}, 0, {   990,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   -37,     11,    -37}, 0, {     0,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   -37,     11,     38}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
};

// 0x07022EE8 - 0x07022FE8
static const Vtx hmc_seg7_vertex_07022EE8[] = {
    {{{   -50,      0,    -50}, 0, {     0,      0}, {0x5a, 0x5a, 0x5a,  0xff}}},
    {{{   -37,     11,    -37}, 0, {     0,      0}, {0x5a, 0x5a, 0x5a,  0xff}}},
    {{{    51,      0,    -50}, 0, {     0,      0}, {0x5a, 0x5a, 0x5a,  0xff}}},
    {{{    38,     11,    -37}, 0, {     0,      0}, {0x5a, 0x5a, 0x5a,  0xff}}},
    {{{    51,      0,    -50}, 0, {     0,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{    38,     11,    -37}, 0, {     0,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{    51,      0,     51}, 0, {     0,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{    38,     11,     38}, 0, {     0,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{   -37,     11,     38}, 0, {     0,      0}, {0x5a, 0x5a, 0x5a,  0xff}}},
    {{{   -37,     11,    -37}, 0, {     0,      0}, {0x5a, 0x5a, 0x5a,  0xff}}},
    {{{   -50,      0,    -50}, 0, {     0,      0}, {0x5a, 0x5a, 0x5a,  0xff}}},
    {{{   -50,      0,     51}, 0, {     0,      0}, {0x5a, 0x5a, 0x5a,  0xff}}},
    {{{    38,     11,     38}, 0, {     0,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{   -50,      0,     51}, 0, {     0,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{    51,      0,     51}, 0, {     0,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{   -37,     11,     38}, 0, {     0,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
};
