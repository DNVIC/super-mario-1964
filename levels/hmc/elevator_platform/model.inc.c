...
static const Vtx hmc_seg7_vertex_07022928[] = {
    {{{  -255,      0,   -255}, 0, {   990,     96}, {0xba, 0xba, 0xba,  0xff}}},
    {{{   256,    102,   -255}, 0, {     0,      0}, {0x63, 0x63, 0x63,  0xff}}},
    {{{   256,      0,   -255}, 0, {     0,     96}, {0xab, 0xab, 0xab,  0xff}}},
    {{{   256,      0,    256}, 0, {   990,      0}, {0x63, 0x63, 0x63,  0xff}}},
    {{{  -255,      0,    256}, 0, {   990,    990}, {0x88, 0x88, 0x88,  0xff}}},
    {{{  -255,      0,   -255}, 0, {     0,    990}, {0xba, 0xba, 0xba,  0xff}}},
    {{{   256,      0,   -255}, 0, {     0,      0}, {0xab, 0xab, 0xab,  0xff}}},
    {{{  -255,    102,    256}, 0, {   990,    990}, {0x7f, 0x7f, 0x7f,  0xff}}},
    {{{   256,    102,    256}, 0, {   990,      0}, {0x44, 0x44, 0x44,  0xff}}},
    {{{  -255,    102,   -255}, 0, {     0,    990}, {0x88, 0x88, 0x88,  0xff}}},
    {{{   256,      0,    256}, 0, {   990,     96}, {0x63, 0x63, 0x63,  0xff}}},
    {{{  -255,    102,    256}, 0, {     0,      0}, {0x7f, 0x7f, 0x7f,  0xff}}},
    {{{  -255,    102,   -255}, 0, {   990,      0}, {0x88, 0x88, 0x88,  0xff}}},
    {{{  -255,      0,    256}, 0, {     0,     96}, {0x88, 0x88, 0x88,  0xff}}},
};
