...
static const Vtx hmc_seg7_vertex_07023178[] = {
    {{{  -204,      0,      0}, 0, {  2012,   2012}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -173,    102,     33}, 0, {  2830,   3448}, {0x4e, 0x4e, 0x4e,  0xff}}},
    {{{  -173,     63,    -86}, 0, {  3648,   3448}, {0x82, 0x82, 0x82,  0xff}}},
    {{{  -173,      0,    108}, 0, {  2012,   3448}, {0x49, 0x49, 0x49,  0xff}}},
    {{{   -91,    108,    148}, 0, {  2420,   4888}, {0x73, 0x73, 0x73,  0xff}}},
    {{{   -91,      0,    183}, 0, {  2012,   4888}, {0x68, 0x68, 0x68,  0xff}}},
    {{{   -91,    174,     57}, 0, {  2830,   4888}, {0x72, 0x72, 0x72,  0xff}}},
    {{{     0,    -62,    195}, 0, {  1808,   6096}, {0x70, 0x70, 0x70,  0xff}}},
    {{{     0,     63,    195}, 0, {  2216,   6096}, {0x35, 0x35, 0x35,  0xff}}},
    {{{    92,      0,    183}, 0, {  2012,   7304}, {0x39, 0x39, 0x39,  0xff}}},
    {{{    92,   -107,    148}, 0, {  1604,   7304}, {0x70, 0x70, 0x70,  0xff}}},
    {{{    92,    108,    148}, 0, {  2420,   7304}, {0x48, 0x48, 0x48,  0xff}}},
    {{{   -91,    174,    -56}, 0, {  3238,   4888}, {0xad, 0xad, 0xad,  0xff}}},
    {{{   -91,    108,   -147}, 0, {  3648,   4888}, {0x8f, 0x8f, 0x8f,  0xff}}},
    {{{     0,    166,    120}, 0, {  2626,   6096}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{     0,    205,      0}, 0, {  3034,   6096}, {0x2a, 0x2a, 0x2a,  0xff}}},
};
...
static const Vtx hmc_seg7_vertex_07023278[] = {
    {{{     0,    166,    120}, 0, {  2626,   6096}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{    92,    108,    148}, 0, {  2420,   7304}, {0x48, 0x48, 0x48,  0xff}}},
    {{{    92,    174,     57}, 0, {  2830,   7304}, {0x43, 0x43, 0x43,  0xff}}},
    {{{     0,    205,      0}, 0, {  3034,   6096}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    92,    174,    -56}, 0, {  3238,   7304}, {0x80, 0x80, 0x80,  0xff}}},
    {{{  -204,      0,      0}, 0, {     0,   2012}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -173,     63,    -86}, 0, {  -438,   3448}, {0x82, 0x82, 0x82,  0xff}}},
    {{{  -173,    -62,    -86}, 0, {   376,   3448}, {0xbd, 0xbd, 0xbd,  0xff}}},
    {{{     0,     63,   -194}, 0, {  3852,   6096}, {0x3a, 0x3a, 0x3a,  0xff}}},
    {{{    92,    108,   -147}, 0, {  3648,   7304}, {0x62, 0x62, 0x62,  0xff}}},
    {{{    92,      0,   -182}, 0, {  4056,   7304}, {0x42, 0x42, 0x42,  0xff}}},
    {{{   -91,      0,   -182}, 0, {     0,   4888}, {0x71, 0x71, 0x71,  0xff}}},
    {{{   -91,   -107,   -147}, 0, {   376,   4888}, {0xb8, 0xb8, 0xb8,  0xff}}},
    {{{  -173,     63,    -86}, 0, {  3648,   3448}, {0x82, 0x82, 0x82,  0xff}}},
    {{{   -91,    108,   -147}, 0, {  3648,   4888}, {0x8f, 0x8f, 0x8f,  0xff}}},
    {{{   -91,      0,   -182}, 0, {  4056,   4888}, {0x71, 0x71, 0x71,  0xff}}},
};

// 0x07023378 - 0x07023478
static const Vtx hmc_seg7_vertex_07023378[] = {
    {{{   -91,    108,   -147}, 0, {  3648,   4888}, {0x8f, 0x8f, 0x8f,  0xff}}},
    {{{     0,    166,   -119}, 0, {  3442,   6096}, {0x5f, 0x5f, 0x5f,  0xff}}},
    {{{     0,     63,   -194}, 0, {  3852,   6096}, {0x3a, 0x3a, 0x3a,  0xff}}},
    {{{    92,    108,   -147}, 0, {  3648,   7304}, {0x62, 0x62, 0x62,  0xff}}},
    {{{    92,    174,    -56}, 0, {  3238,   7304}, {0x80, 0x80, 0x80,  0xff}}},
    {{{  -204,      0,      0}, 0, {  2012,   2012}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -173,   -101,     33}, 0, {  1194,   3448}, {0x78, 0x78, 0x78,  0xff}}},
    {{{  -173,      0,    108}, 0, {  2012,   3448}, {0x49, 0x49, 0x49,  0xff}}},
    {{{  -204,      0,      0}, 0, {     0,   2012}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -173,    -62,    -86}, 0, {   376,   3448}, {0xbd, 0xbd, 0xbd,  0xff}}},
    {{{   -91,   -173,    -56}, 0, {   786,   4888}, {0xbd, 0xbd, 0xbd,  0xff}}},
    {{{   -91,   -107,   -147}, 0, {   376,   4888}, {0xb8, 0xb8, 0xb8,  0xff}}},
    {{{   -91,   -173,     57}, 0, {  1194,   4888}, {0x80, 0x80, 0x80,  0xff}}},
    {{{     0,    -62,   -194}, 0, {   172,   6096}, {0x76, 0x76, 0x76,  0xff}}},
    {{{     0,   -165,   -119}, 0, {   582,   6096}, {0x70, 0x70, 0x70,  0xff}}},
    {{{    92,   -107,   -147}, 0, {   376,   7304}, {0x8d, 0x8d, 0x8d,  0xff}}},
};

// 0x07023478 - 0x07023558
static const Vtx hmc_seg7_vertex_07023478[] = {
    {{{     0,    -62,   -194}, 0, {   172,   6096}, {0x76, 0x76, 0x76,  0xff}}},
    {{{    92,      0,   -182}, 0, {     0,   7304}, {0x42, 0x42, 0x42,  0xff}}},
    {{{    92,   -107,   -147}, 0, {   376,   7304}, {0x8d, 0x8d, 0x8d,  0xff}}},
    {{{     0,   -165,   -119}, 0, {   582,   6096}, {0x70, 0x70, 0x70,  0xff}}},
    {{{    92,   -173,    -56}, 0, {   786,   7304}, {0x8e, 0x8e, 0x8e,  0xff}}},
    {{{  -173,   -101,     33}, 0, {  1194,   3448}, {0x78, 0x78, 0x78,  0xff}}},
    {{{   -91,   -107,    148}, 0, {  1604,   4888}, {0x9e, 0x9e, 0x9e,  0xff}}},
    {{{  -173,      0,    108}, 0, {  2012,   3448}, {0x49, 0x49, 0x49,  0xff}}},
    {{{   -91,   -173,     57}, 0, {  1194,   4888}, {0x80, 0x80, 0x80,  0xff}}},
    {{{   -91,      0,    183}, 0, {  2012,   4888}, {0x68, 0x68, 0x68,  0xff}}},
    {{{     0,   -204,      0}, 0, {   990,   6096}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{     0,   -165,    120}, 0, {  1398,   6096}, {0x4c, 0x4c, 0x4c,  0xff}}},
    {{{    92,   -173,     57}, 0, {  1194,   7304}, {0x53, 0x53, 0x53,  0xff}}},
    {{{    92,   -107,    148}, 0, {  1604,   7304}, {0x70, 0x70, 0x70,  0xff}}},
};

// 0x07023558 - 0x07023638
static const Vtx hmc_seg7_vertex_07023558[] = {
    {{{   205,      0,      0}, 0, {  4056,  10184}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   174,      0,   -107}, 0, {  4056,   8744}, {0x62, 0x62, 0x62,  0xff}}},
    {{{   174,    102,    -32}, 0, {  3238,   8744}, {0x87, 0x87, 0x87,  0xff}}},
    {{{     0,     63,   -194}, 0, {  3852,   6096}, {0x3a, 0x3a, 0x3a,  0xff}}},
    {{{   -91,      0,   -182}, 0, {  4056,   4888}, {0x71, 0x71, 0x71,  0xff}}},
    {{{   -91,    108,   -147}, 0, {  3648,   4888}, {0x8f, 0x8f, 0x8f,  0xff}}},
    {{{    92,    108,   -147}, 0, {  3648,   7304}, {0x62, 0x62, 0x62,  0xff}}},
    ...
    {{{    92,      0,   -182}, 0, {     0,   7304}, {0x42, 0x42, 0x42,  0xff}}},
    {{{     0,    -62,   -194}, 0, {   172,   6096}, {0x76, 0x76, 0x76,  0xff}}},
    {{{     0,     63,   -194}, 0, {  -234,   6096}, {0x3a, 0x3a, 0x3a,  0xff}}},
    {{{   -91,   -107,   -147}, 0, {   376,   4888}, {0xb8, 0xb8, 0xb8,  0xff}}},
    {{{   -91,      0,   -182}, 0, {     0,   4888}, {0x71, 0x71, 0x71,  0xff}}},
};
...
static const Vtx hmc_seg7_vertex_07023638[] = {
    {{{   205,      0,      0}, 0, {  2012,  10184}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   174,     63,     87}, 0, {  2420,   8744}, {0x43, 0x43, 0x43,  0xff}}},
    {{{   174,    -62,     87}, 0, {  1604,   8744}, {0x7e, 0x7e, 0x7e,  0xff}}},
    {{{   205,      0,      0}, 0, {  4056,  10184}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   174,    102,    -32}, 0, {  3238,   8744}, {0x87, 0x87, 0x87,  0xff}}},
    {{{    92,    174,     57}, 0, {  2830,   7304}, {0x43, 0x43, 0x43,  0xff}}},
    {{{    92,    174,    -56}, 0, {  3238,   7304}, {0x80, 0x80, 0x80,  0xff}}},
...
static const Vtx hmc_seg7_vertex_07023728[] = {
    ...
    {{{   205,      0,      0}, 0, {  2012,  10184}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   174,    -62,     87}, 0, {  1604,   8744}, {0x7e, 0x7e, 0x7e,  0xff}}},
    {{{   174,   -101,    -32}, 0, {   786,   8744}, {0xb2, 0xb2, 0xb2,  0xff}}},
    {{{    92,   -107,    148}, 0, {  1604,   7304}, {0x70, 0x70, 0x70,  0xff}}},
    {{{    92,   -173,     57}, 0, {  1194,   7304}, {0x53, 0x53, 0x53,  0xff}}},
    {{{    92,   -173,    -56}, 0, {   786,   7304}, {0x8e, 0x8e, 0x8e,  0xff}}},
    {{{     0,    -62,    195}, 0, {  1808,   6096}, {0x70, 0x70, 0x70,  0xff}}},
...
static const Vtx hmc_seg7_vertex_07023828[] = {
    {{{   205,      0,      0}, 0, {     0,  10184}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   174,   -101,    -32}, 0, {   786,   8744}, {0xb2, 0xb2, 0xb2,  0xff}}},
    {{{   174,      0,   -107}, 0, {     0,   8744}, {0x62, 0x62, 0x62,  0xff}}},
    {{{     0,   -165,   -119}, 0, {   582,   6096}, {0x70, 0x70, 0x70,  0xff}}},
    {{{   -91,   -173,    -56}, 0, {   786,   4888}, {0xbd, 0xbd, 0xbd,  0xff}}},
    {{{   -91,   -107,   -147}, 0, {   376,   4888}, {0xb8, 0xb8, 0xb8,  0xff}}},
    {{{    92,   -107,   -147}, 0, {   376,   7304}, {0x8d, 0x8d, 0x8d,  0xff}}},
