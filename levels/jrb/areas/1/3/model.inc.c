...
static const Vtx jrb_seg7_vertex_07004A48[] = {
    {{{ -1944,    512,   7211}, 0, { 19276,      0}, {0x37, 0x37, 0x37,  0xff}}},
    {{{ -1675,    512,   6547}, 0, { 15876,      0}, {0x76, 0x76, 0x76,  0xff}}},
    {{{ -1675,   1024,   6547}, 0, { 15876,   2522}, {0x76, 0x76, 0x76,  0xff}}},
    {{{ -1944,   1024,   7211}, 0, { 19276,   2522}, {0x37, 0x37, 0x37,  0xff}}},
    {{{ -2073,    512,   6165}, 0, { 12960,      0}, {0x3c, 0x3c, 0x3c,  0xff}}},
    {{{ -2073,   1024,   6165}, 0, { 12960,   2522}, {0x7a, 0x7a, 0x7a,  0xff}}},
    {{{ -3017,    512,   6778}, 0, {  7700,      0}, {0x70, 0x70, 0x70,  0xff}}},
    {{{ -3017,   1024,   6778}, 0, {  7700,   2522}, {0x70, 0x70, 0x70,  0xff}}},
};

// 0x07004AC8 - 0x07004B88
static const Vtx jrb_seg7_vertex_07004AC8[] = {
    {{{ -2771,      0,   1676}, 0, {  1672,    554}, {0x7b, 0x7b, 0x7b,  0xff}}},
    {{{  -705,      0,   2401}, 0, {  1672,   -520}, {0x6f, 0x6f, 0x6f,  0xff}}},
    {{{  -705,    512,   2401}, 0, {  1840,   -520}, {0x6f, 0x6f, 0x6f,  0xff}}},
    {{{ -4161,    512,   6315}, 0, {  1840,    886}, {0x60, 0x60, 0x60,  0xff}}},
    {{{ -5256,   1024,   4733}, 0, {  2012,   1544}, {0x6d, 0x6d, 0x6d,  0xff}}},
    {{{ -4161,   1024,   6315}, 0, {  2012,    886}, {0x60, 0x60, 0x60,  0xff}}},
    {{{ -5256,    512,   4733}, 0, {  1840,   1544}, {0x79, 0x79, 0x79,  0xff}}},
    {{{ -5170,    614,   3362}, 0, {  1876,   1608}, {0x34, 0x34, 0x34,  0xff}}},
    {{{ -5170,      0,   3362}, 0, {  1672,   1608}, {0x39, 0x39, 0x39,  0xff}}},
    {{{ -4133,    614,   2187}, 0, {  1876,   1186}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{ -4133,      0,   2187}, 0, {  1672,   1186}, {0x3a, 0x3a, 0x3a,  0xff}}},
    {{{ -2771,    614,   1676}, 0, {  1876,    554}, {0x2f, 0x2f, 0x2f,  0xff}}},
};
