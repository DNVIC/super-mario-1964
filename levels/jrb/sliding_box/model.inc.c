...
static const Vtx jrb_seg7_vertex_07007EB8[] = {
    {{{   102,      0,     77}, 0, {   990,    990}, {0x78, 0x78, 0x78,  0xff}}},
    {{{   102,    154,     77}, 0, {   990,      0}, {0x46, 0x46, 0x46,  0xff}}},
    {{{  -101,    154,     77}, 0, {     0,      0}, {0x78, 0x78, 0x78,  0xff}}},
    {{{   102,      0,    -76}, 0, {   990,    990}, {0x9d, 0x9d, 0x9d,  0xff}}},
    {{{   102,    154,     77}, 0, {     0,      0}, {0x46, 0x46, 0x46,  0xff}}},
    {{{   102,      0,     77}, 0, {     0,    990}, {0x78, 0x78, 0x78,  0xff}}},
    {{{   102,    154,    -76}, 0, {   990,      0}, {0x55, 0x55, 0x55,  0xff}}},
    {{{  -101,      0,    -76}, 0, {   990,    990}, {0xbc, 0xbc, 0xbc,  0xff}}},
    {{{   102,    154,    -76}, 0, {     0,      0}, {0x55, 0x55, 0x55,  0xff}}},
    {{{   102,      0,    -76}, 0, {     0,    990}, {0x9d, 0x9d, 0x9d,  0xff}}},
    {{{  -101,    154,    -76}, 0, {   990,      0}, {0x9d, 0x9d, 0x9d,  0xff}}},
    {{{  -101,      0,     77}, 0, {   990,    990}, {0x81, 0x81, 0x81,  0xff}}},
    {{{  -101,    154,     77}, 0, {   990,      0}, {0x78, 0x78, 0x78,  0xff}}},
    {{{  -101,    154,    -76}, 0, {     0,      0}, {0x9d, 0x9d, 0x9d,  0xff}}},
    {{{  -101,      0,    -76}, 0, {     0,    990}, {0xbc, 0xbc, 0xbc,  0xff}}},
    {{{  -101,      0,     77}, 0, {     0,    990}, {0x81, 0x81, 0x81,  0xff}}},
};

// 0x07007FB8 - 0x07008038
static const Vtx jrb_seg7_vertex_07007FB8[] = {
    {{{  -101,      0,     77}, 0, {     0,      0}, {0x81, 0x81, 0x81,  0xff}}},
    {{{   102,      0,    -76}, 0, {   990,    990}, {0x9d, 0x9d, 0x9d,  0xff}}},
    {{{   102,      0,     77}, 0, {   990,      0}, {0x78, 0x78, 0x78,  0xff}}},
    {{{  -101,      0,    -76}, 0, {     0,    990}, {0xbc, 0xbc, 0xbc,  0xff}}},
    {{{   102,    154,     77}, 0, {   990,    990}, {0x46, 0x46, 0x46,  0xff}}},
    {{{   102,    154,    -76}, 0, {   990,      0}, {0x55, 0x55, 0x55,  0xff}}},
    {{{  -101,    154,    -76}, 0, {     0,      0}, {0x9d, 0x9d, 0x9d,  0xff}}},
    {{{  -101,    154,     77}, 0, {     0,    990}, {0x78, 0x78, 0x78,  0xff}}},
};
