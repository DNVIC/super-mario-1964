...
static const Vtx lll_seg7_vertex_07016670[] = {
    {{{   325,    282,   -210}, 0, {   180,    494}, {0x75, 0x75, 0x75,  0xff}}},
    {{{   186,    512,   -107}, 0, {   526,    236}, {0x78, 0x78, 0x78,  0xff}}},
    {{{   335,    282,    194}, 0, {   154,   -514}, {0x45, 0x45, 0x45,  0xff}}},
    {{{   186,    512,    108}, 0, {   526,   -300}, {0xc4, 0xc4, 0xc4,  0xff}}},
    {{{     0,    282,    387}, 0, {   990,   -998}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{   640,      0,   -383}, 0, {  -604,    926}, {0x86, 0x86, 0x86,  0xff}}},
    {{{   640,      0,    384}, 0, {  -604,   -990}, {0x44, 0x44, 0x44,  0xff}}},
    {{{     0,      0,    768}, 0, {   990,  -1948}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{     0,    512,    215}, 0, {   990,   -568}, {0x61, 0x61, 0x61,  0xff}}},
    {{{  -185,    512,    108}, 0, {  1454,   -300}, {0x42, 0x42, 0x42,  0xff}}},
    {{{  -334,    282,    194}, 0, {  1826,   -514}, {0x64, 0x64, 0x64,  0xff}}},
    {{{  -639,      0,    384}, 0, {  2586,   -990}, {0x6c, 0x6c, 0x6c,  0xff}}},
    {{{     0,      0,   -767}, 0, {   990,   1882}, {0x5e, 0x5e, 0x5e,  0xff}}},
    {{{     0,    282,   -386}, 0, {   990,    934}, {0x56, 0x56, 0x56,  0xff}}},
    {{{     0,    512,   -214}, 0, {   990,    504}, {0xc5, 0xc5, 0xc5,  0xff}}},
    {{{  -324,    282,   -210}, 0, {  1800,    494}, {0x9e, 0x9e, 0x9e,  0xff}}},
};

// 0x07016770 - 0x070167F0
static const Vtx lll_seg7_vertex_07016770[] = {
    {{{  -324,    282,   -210}, 0, {  1800,    494}, {0x9e, 0x9e, 0x9e,  0xff}}},
    {{{  -185,    512,   -107}, 0, {  1454,    236}, {0x8d, 0x8d, 0x8d,  0xff}}},
    {{{     0,    512,   -214}, 0, {   990,    504}, {0xc5, 0xc5, 0xc5,  0xff}}},
    {{{  -334,    282,    194}, 0, {  1826,   -514}, {0x64, 0x64, 0x64,  0xff}}},
    {{{  -639,      0,   -383}, 0, {  2586,    926}, {0xaa, 0xaa, 0xaa,  0xff}}},
    {{{     0,      0,   -767}, 0, {   990,   1882}, {0x5e, 0x5e, 0x5e,  0xff}}},
    {{{  -185,    512,    108}, 0, {  1454,   -300}, {0x42, 0x42, 0x42,  0xff}}},
    {{{  -639,      0,    384}, 0, {  2586,   -990}, {0x6c, 0x6c, 0x6c,  0xff}}},
};
...
static const Vtx lll_seg7_vertex_070167F0[] = {
    {{{     0,    102,   -214}, 0, {   990,    478}, {0x3e, 0x3e, 0x3e,  0xff}}},
    {{{   186,    102,    108}, 0, {   224,    922}, {0x99, 0x99, 0x99,  0xff}}},
    {{{   186,    102,   -107}, 0, {   734,    922}, {0x60, 0x60, 0x60,  0xff}}},
    {{{     0,    102,    215}, 0, {     0,    480}, {0x9d, 0x9d, 0x9d,  0xff}}},
    {{{  -185,    102,   -107}, 0, {   734,     36}, {0x41, 0x41, 0x41,  0xff}}},
    {{{  -185,    102,    108}, 0, {   224,     36}, {0x72, 0x72, 0x72,  0xff}}},
};

// 0x07016850 - 0x07016930
static const Vtx lll_seg7_vertex_07016850[] = {
    {{{   186,    512,   -107}, 0, {  3546,      0}, {0x78, 0x78, 0x78,  0xff}}},
    {{{   186,    102,   -107}, 0, {  3546,    942}, {0x60, 0x60, 0x60,  0xff}}},
    {{{   186,    102,    108}, 0, {  2524,    942}, {0x99, 0x99, 0x99,  0xff}}},
    {{{   186,    512,    108}, 0, {  2524,      0}, {0xc4, 0xc4, 0xc4,  0xff}}},
    {{{     0,    512,   -214}, 0, {  4568,      0}, {0xc5, 0xc5, 0xc5,  0xff}}},
    {{{     0,    102,   -214}, 0, {  4568,    942}, {0x3e, 0x3e, 0x3e,  0xff}}},
    {{{     0,    102,    215}, 0, {  1502,    942}, {0x9d, 0x9d, 0x9d,  0xff}}},
    {{{     0,    512,    215}, 0, {  1502,      0}, {0x61, 0x61, 0x61,  0xff}}},
    {{{  -185,    102,    108}, 0, {   480,    942}, {0x72, 0x72, 0x72,  0xff}}},
    {{{  -185,    512,    108}, 0, {   480,      0}, {0x42, 0x42, 0x42,  0xff}}},
    {{{  -185,    512,    108}, 0, {  6612,      0}, {0x42, 0x42, 0x42,  0xff}}},
    {{{  -185,    102,   -107}, 0, {  5590,    942}, {0x41, 0x41, 0x41,  0xff}}},
    {{{  -185,    512,   -107}, 0, {  5590,      0}, {0x8d, 0x8d, 0x8d,  0xff}}},
    {{{  -185,    102,    108}, 0, {  6612,    942}, {0x72, 0x72, 0x72,  0xff}}},
};
