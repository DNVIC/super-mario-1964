...
static const Vtx lll_seg7_vertex_07017938[] = {
    ...
    {{{  -127,    307,   -127}, 0, {   990,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   128,    307,   -127}, 0, {   138,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   128,      0,   -127}, 0, {   138,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -127,      0,    128}, 0, {   820,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -127,    307,    128}, 0, {   820,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -127,    307,   -127}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -127,      0,   -127}, 0, {     0,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   128,      0,   -127}, 0, {   820,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   128,    307,    128}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   128,      0,    128}, 0, {     0,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   128,    307,   -127}, 0, {   820,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
};

// 0x070179F8 - 0x07017A38
static const Vtx lll_seg7_vertex_070179F8[] = {
    {{{  -127,    307,   -127}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   128,    307,    128}, 0, {   820,    820}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   128,    307,   -127}, 0, {   820,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -127,    307,    128}, 0, {     0,    820}, {0x2a, 0x2a, 0x2a,  0xff}}},
};

// 0x07017A38 - 0x07017A78
static const Vtx lll_seg7_vertex_07017A38[] = {
    {{{   128,      0,    128}, 0, {   990,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   128,    307,    128}, 0, {   990,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -127,    307,    128}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
