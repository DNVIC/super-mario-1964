...
static const Vtx lll_seg7_vertex_070183F0[] = {
    {{{     0,   -101,   -191}, 0, {     0,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{     0,      0,    192}, 0, {  3800,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{     0,   -101,    192}, 0, {  3800,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{     0,      0,   -191}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -639,   -101,    192}, 0, {  3800,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -639,      0,   -191}, 0, {     0,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -639,   -101,   -191}, 0, {     0,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -639,      0,    192}, 0, {  3800,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
};

// 0x07018470 - 0x070184B0
static const Vtx lll_seg7_vertex_07018470[] = {
    {{{     0,      0,   -191}, 0, { -5140,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -639,      0,   -191}, 0, {     0,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -639,      0,    192}, 0, {     0,  -2076}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{     0,      0,    192}, 0, { -5140,  -2076}, {0x2a, 0x2a, 0x2a,  0xff}}},
};

// 0x070184B0 - 0x070184F0
static const Vtx lll_seg7_vertex_070184B0[] = {
    {{{     0,   -101,    192}, 0, { -3352,    862}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -639,   -101,    192}, 0, {  -158,    862}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -639,   -101,   -191}, 0, {  -158,  -1054}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{     0,   -101,   -191}, 0, { -3352,  -1054}, {0x2b, 0x2b, 0x2b,  0xff}}},
};

// 0x070184F0 - 0x07018570
static const Vtx lll_seg7_vertex_070184F0[] = {
    {{{     0,   -101,    192}, 0, {  5334,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{     0,      0,    192}, 0, {  5334,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -639,      0,    192}, 0, { -1052,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -639,   -101,    192}, 0, { -1052,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -639,   -101,   -191}, 0, {  2268,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -639,      0,   -191}, 0, {  2268,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{     0,      0,   -191}, 0, { -4118,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{     0,   -101,   -191}, 0, { -4118,    990}, {0x2b, 0x2b, 0x2b,  0xff}}},
};
