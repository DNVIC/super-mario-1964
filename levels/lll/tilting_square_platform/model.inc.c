...
static const Vtx lll_seg7_vertex_0701A080[] = {
    {{{     0,      0,      0}, 0, {   480,    478}, {0x55, 0x55, 0x55,  0xff}}},
    {{{  -306,    307,   -306}, 0, {     0,    990}, {0x55, 0x55, 0x55,  0xff}}},
    {{{   307,    307,   -306}, 0, {   990,    990}, {0x55, 0x55, 0x55,  0xff}}},
    {{{   307,    307,    307}, 0, {   990,      0}, {0x55, 0x55, 0x55,  0xff}}},
    {{{  -306,    307,    307}, 0, {     0,      0}, {0x55, 0x55, 0x55,  0xff}}},
    {{{     0,      0,      0}, 0, {   480,    478}, {0x43, 0x43, 0x43,  0xff}}},
    {{{  -306,    307,    307}, 0, {     0,      0}, {0x43, 0x43, 0x43,  0xff}}},
    {{{  -306,    307,   -306}, 0, {     0,    990}, {0x43, 0x43, 0x43,  0xff}}},
    {{{   307,    307,   -306}, 0, {   990,    990}, {0x43, 0x43, 0x43,  0xff}}},
    {{{   307,    307,    307}, 0, {   990,      0}, {0x43, 0x43, 0x43,  0xff}}},
};

// 0x0701A120 - 0x0701A160
static const Vtx lll_seg7_vertex_0701A120[] = {
    {{{   307,    307,    307}, 0, {   990,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -306,    307,   -306}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -306,    307,    307}, 0, {     0,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   307,    307,   -306}, 0, {   990,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
};
