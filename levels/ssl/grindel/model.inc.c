...
static const Vtx ssl_seg7_vertex_07021E68[] = {
    {{{  -224,      0,   -224}, 0, {   990,    990}, {0xba, 0xba, 0xba,  0xff}}},
    {{{   224,      0,    224}, 0, {     0,      0}, {0x63, 0x63, 0x63,  0xff}}},
    {{{  -224,      0,    224}, 0, {     0,    990}, {0x88, 0x88, 0x88,  0xff}}},
    {{{   224,      0,   -224}, 0, {   990,      0}, {0xab, 0xab, 0xab,  0xff}}},
    {{{  -224,    450,    224}, 0, {     0,    990}, {0x7f, 0x7f, 0x7f,  0xff}}},
    {{{   224,    450,   -224}, 0, {   990,      0}, {0x63, 0x63, 0x63,  0xff}}},
    {{{  -224,    450,   -224}, 0, {   990,    990}, {0x88, 0x88, 0x88,  0xff}}},
    {{{   224,    450,    224}, 0, {     0,      0}, {0x44, 0x44, 0x44,  0xff}}},
};

// 0x07021EE8 - 0x07021FE8
static const Vtx ssl_seg7_vertex_07021EE8[] = {
    {{{   224,    450,   -224}, 0, {     0,      0}, {0x63, 0x63, 0x63,  0xff}}},
    {{{  -224,      0,   -224}, 0, {   990,   2012}, {0xba, 0xba, 0xba,  0xff}}},
    {{{  -224,    450,   -224}, 0, {   990,      0}, {0x88, 0x88, 0x88,  0xff}}},
    {{{  -224,    450,    224}, 0, {     0,      0}, {0x7f, 0x7f, 0x7f,  0xff}}},
    {{{   224,      0,    224}, 0, {   990,   2012}, {0x63, 0x63, 0x63,  0xff}}},
    {{{   224,    450,    224}, 0, {   990,      0}, {0x44, 0x44, 0x44,  0xff}}},
    {{{  -224,      0,    224}, 0, {     0,   2012}, {0x88, 0x88, 0x88,  0xff}}},
    {{{  -224,    450,   -224}, 0, {     0,      0}, {0x88, 0x88, 0x88,  0xff}}},
    {{{  -224,      0,   -224}, 0, {     0,   2012}, {0xba, 0xba, 0xba,  0xff}}},
    {{{  -224,      0,    224}, 0, {   990,   2012}, {0x88, 0x88, 0x88,  0xff}}},
    {{{  -224,    450,    224}, 0, {   990,      0}, {0x7f, 0x7f, 0x7f,  0xff}}},
    {{{   224,    450,    224}, 0, {     0,      0}, {0x44, 0x44, 0x44,  0xff}}},
    {{{   224,      0,    224}, 0, {     0,   2012}, {0x63, 0x63, 0x63,  0xff}}},
    {{{   224,      0,   -224}, 0, {   990,   2012}, {0xab, 0xab, 0xab,  0xff}}},
    {{{   224,    450,   -224}, 0, {   990,      0}, {0x63, 0x63, 0x63,  0xff}}},
    {{{   224,      0,   -224}, 0, {     0,   2012}, {0xab, 0xab, 0xab,  0xff}}},
};
