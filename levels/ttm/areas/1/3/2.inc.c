...
static const Vtx ttm_seg7_vertex_0700A940[] = {
    {{{    80,    654,   -199}, 0, {   308,    138}, {0x8a, 0x8a, 0x8a,  0xff}}},
    {{{   -22,    654,   -199}, 0, {   308,    138}, {0x96, 0x96, 0x96,  0xff}}},
    {{{   -22,  -1719,    -97}, 0, {     0,    990}, {0x6a, 0x6a, 0x6a,  0xff}}},
    {{{    80,  -1719,    -97}, 0, {     0,    990}, {0x39, 0x39, 0x39,  0xff}}},
    {{{    80,    654,   -302}, 0, {   650,    138}, {0x5f, 0x5f, 0x5f,  0xff}}},
    {{{   -22,  -1719,   -199}, 0, {   308,    990}, {0xc4, 0xc4, 0xc4,  0xff}}},
    {{{   -22,    654,   -302}, 0, {   650,    138}, {0x76, 0x76, 0x76,  0xff}}},
    {{{    80,  -1719,   -199}, 0, {   308,    990}, {0xaa, 0xaa, 0xaa,  0xff}}},
};

// 0x0700A9C0 - 0x0700AA40
static const Vtx ttm_seg7_vertex_0700A9C0[] = {
    {{{    80,    654,   -302}, 0, {     0,      0}, {0x5f, 0x5f, 0x5f,  0xff}}},
    {{{    80,   1473,      5}, 0, {     0,      0}, {0x89, 0x89, 0x89,  0xff}}},
    {{{    80,    654,   -199}, 0, {     0,      0}, {0x8a, 0x8a, 0x8a,  0xff}}},
    {{{   -22,   1473,      5}, 0, {     0,      0}, {0xb4, 0xb4, 0xb4,  0xff}}},
    {{{   -22,    654,   -199}, 0, {     0,      0}, {0x96, 0x96, 0x96,  0xff}}},
    {{{    80,   1473,    -97}, 0, {     0,      0}, {0x4c, 0x4c, 0x4c,  0xff}}},
    {{{   -22,   1473,    -97}, 0, {     0,      0}, {0x77, 0x77, 0x77,  0xff}}},
    {{{   -22,    654,   -302}, 0, {     0,      0}, {0x76, 0x76, 0x76,  0xff}}},
};
