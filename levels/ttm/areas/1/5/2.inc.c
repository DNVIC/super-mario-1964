...
static const Vtx ttm_seg7_vertex_0700B5A8[] = {
    {{{    29,  -1653,     57}, 0, {   990,    990}, {0x50, 0x50, 0x50,  0xff}}},
    {{{    14,   1556,    -28}, 0, {   510,      0}, {0x75, 0x75, 0x75,  0xff}}},
    {{{    14,  -1653,    -28}, 0, {   510,    990}, {0x7a, 0x7a, 0x7a,  0xff}}},
    {{{    98,   1556,      2}, 0, {     0,      0}, {0x5a, 0x5a, 0x5a,  0xff}}},
    {{{    98,  -1653,      2}, 0, {     0,    990}, {0x37, 0x37, 0x37,  0xff}}},
    {{{    29,   1556,     57}, 0, {   990,      0}, {0x30, 0x30, 0x30,  0xff}}},
};
