...
static const Vtx ttm_seg7_vertex_0700BB48[] = {
    {{{   -13,  -1627,     28}, 0, {   990,    990}, {0x6e, 0x6e, 0x6e,  0xff}}},
    {{{   -28,   1580,    -57}, 0, {   510,      0}, {0x6f, 0x6f, 0x6f,  0xff}}},
    {{{   -28,  -1627,    -57}, 0, {   510,    990}, {0x6f, 0x6f, 0x6f,  0xff}}},
    {{{   -13,   1580,     28}, 0, {   990,      0}, {0x6e, 0x6e, 0x6e,  0xff}}},
    {{{    56,  -1627,    -26}, 0, {     0,    990}, {0x5b, 0x5b, 0x5b,  0xff}}},
    {{{    56,   1580,    -26}, 0, {     0,      0}, {0x37, 0x37, 0x37,  0xff}}},
};
