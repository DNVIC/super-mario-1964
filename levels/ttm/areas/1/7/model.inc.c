...
static const Vtx ttm_seg7_vertex_0700BCA0[] = {
    {{{   307,     32,    307}, 0, {     0,   2418}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   307,     32,   -409}, 0, {     0,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -306,     32,   -409}, 0, { -1256,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -306,     32,    307}, 0, { -1256,   2418}, {0x2a, 0x2a, 0x2a,  0xff}}},
};

// 0x0700BCE0 - 0x0700BDA0
static const Vtx ttm_seg7_vertex_0700BCE0[] = {
    {{{   307,     32,   -409}, 0, {     0,    990}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{   307,     32,    307}, 0, {     0,   2418}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{   355,    -15,    355}, 0, {    64,   2514}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{   355,    -15,    355}, 0, {    64,   2514}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{   307,     32,    307}, 0, {     0,   2418}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{  -369,    -30,    370}, 0, { -1380,   2544}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{   307,     32,    307}, 0, {     0,   2418}, {0x3c, 0x3c, 0x3c,  0xff}}},
    {{{  -306,     32,    307}, 0, { -1256,   2418}, {0x3c, 0x3c, 0x3c,  0xff}}},
    {{{  -369,    -30,    370}, 0, { -1380,   2544}, {0x3c, 0x3c, 0x3c,  0xff}}},
    {{{  -369,    -30,    370}, 0, { -1380,   2544}, {0x56, 0x56, 0x56,  0xff}}},
    {{{  -306,     32,    307}, 0, { -1256,   2418}, {0x56, 0x56, 0x56,  0xff}}},
    {{{  -306,     32,   -409}, 0, { -1256,    990}, {0x56, 0x56, 0x56,  0xff}}},
};
