...
static const Vtx ttm_seg7_vertex_0700C128[] = {
    {{{   162,    256,     35}, 0, {     0,  -2076}, {0x6f, 0x6f, 0x6f,  0xff}}},
    {{{    18,   -255,    180}, 0, {   990,    480}, {0x6f, 0x6f, 0x6f,  0xff}}},
    {{{    18,    256,    180}, 0, {   990,  -2076}, {0x6f, 0x6f, 0x6f,  0xff}}},
    {{{    18,    256,    180}, 0, {     0,  -1566}, {0x56, 0x56, 0x56,  0xff}}},
    {{{    18,   -255,    180}, 0, {     0,    990}, {0x56, 0x56, 0x56,  0xff}}},
    {{{  -126,   -255,     35}, 0, {   990,    990}, {0x56, 0x56, 0x56,  0xff}}},
    {{{  -126,    256,     35}, 0, {   990,  -1566}, {0x56, 0x56, 0x56,  0xff}}},
    {{{  -126,    256,     35}, 0, {   990,  -2076}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{  -126,   -255,     35}, 0, {   990,    480}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{    18,   -255,   -109}, 0, {     0,    478}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{    18,    256,   -109}, 0, {     0,  -2076}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{    18,    256,   -109}, 0, {   990,  -1566}, {0x55, 0x55, 0x55,  0xff}}},
    {{{   162,   -255,     35}, 0, {     0,    990}, {0x55, 0x55, 0x55,  0xff}}},
    {{{   162,    256,     35}, 0, {     0,  -1566}, {0x55, 0x55, 0x55,  0xff}}},
    {{{    18,   -255,   -109}, 0, {   990,    990}, {0x55, 0x55, 0x55,  0xff}}},
    {{{   162,   -255,     35}, 0, {     0,    478}, {0x6f, 0x6f, 0x6f,  0xff}}},
};

// 0x0700C228 - 0x0700C2A8
static const Vtx ttm_seg7_vertex_0700C228[] = {
    {{{   307,    256,     35}, 0, { 14686, -17952}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    18,    256,   -253}, 0, { 14108, -18530}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   162,    256,     35}, 0, { 14396, -17952}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    18,    256,   -109}, 0, { 14108, -18240}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -126,    256,     35}, 0, { 13818, -17952}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -271,    256,     35}, 0, { 13528, -17952}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    18,    256,    325}, 0, { 14108, -17374}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    18,    256,    180}, 0, { 14108, -17662}, {0x2a, 0x2a, 0x2a,  0xff}}},
};

// 0x0700C2A8 - 0x0700C2E8
static const Vtx ttm_seg7_vertex_0700C2A8[] = {
    {{{    18,   -255,    180}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   162,   -255,     35}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{    18,   -255,   -109}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -126,   -255,     35}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
};
