...
static const Vtx wdw_seg7_vertex_07012F78[] = {
    {{{   -50,     51,    -50}, 0, {   990,      0}, {0x55, 0x55, 0x55,  0xff}}},
    {{{   -50,     51,     51}, 0, {     0,      0}, {0x55, 0x55, 0x55,  0xff}}},
    {{{     0,    102,      0}, 0, {   480,    932}, {0x55, 0x55, 0x55,  0xff}}},
    {{{    51,     51,    -50}, 0, {   990,      0}, {0x55, 0x55, 0x55,  0xff}}},
    {{{    51,     51,     51}, 0, {     0,      0}, {0x55, 0x55, 0x55,  0xff}}},
    {{{     0,      0,      0}, 0, {   480,    932}, {0x55, 0x55, 0x55,  0xff}}},
};

// 0x07012FD8 - 0x07013038
static const Vtx wdw_seg7_vertex_07012FD8[] = {
    {{{    51,     51,     51}, 0, {   990,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{    51,     51,    -50}, 0, {     0,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{     0,    102,      0}, 0, {   478,    932}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{   -50,     51,     51}, 0, {   990,      0}, {0x6f, 0x6f, 0x6f,  0xff}}},
    {{{   -50,     51,    -50}, 0, {     0,      0}, {0x6f, 0x6f, 0x6f,  0xff}}},
    {{{     0,      0,      0}, 0, {   478,    932}, {0x6f, 0x6f, 0x6f,  0xff}}},
};

// 0x07013038 - 0x07013098
static const Vtx wdw_seg7_vertex_07013038[] = {
    {{{   -50,     51,     51}, 0, {   990,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{    51,     51,     51}, 0, {     0,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{     0,    102,      0}, 0, {   480,    932}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{   -50,     51,    -50}, 0, {   990,      0}, {0x6f, 0x6f, 0x6f,  0xff}}},
    {{{    51,     51,    -50}, 0, {     0,      0}, {0x6f, 0x6f, 0x6f,  0xff}}},
    {{{     0,      0,      0}, 0, {   480,    932}, {0x6f, 0x6f, 0x6f,  0xff}}},
};

// 0x07013098 - 0x070130F8
static const Vtx wdw_seg7_vertex_07013098[] = {
    {{{    51,     51,     51}, 0, {   990,      0}, {0x55, 0x55, 0x55,  0xff}}},
    {{{   -50,     51,     51}, 0, {     0,      0}, {0x55, 0x55, 0x55,  0xff}}},
    {{{     0,      0,      0}, 0, {   478,    932}, {0x55, 0x55, 0x55,  0xff}}},
    {{{    51,     51,    -50}, 0, {   990,      0}, {0x55, 0x55, 0x55,  0xff}}},
    {{{   -50,     51,    -50}, 0, {     0,      0}, {0x55, 0x55, 0x55,  0xff}}},
    {{{     0,    102,      0}, 0, {   478,    932}, {0x55, 0x55, 0x55,  0xff}}},
};
