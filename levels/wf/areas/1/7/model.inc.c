...
static const Vtx wf_seg7_vertex_07006680[] = {
    {{{   256,   1075,   -255}, 0, { -9228,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -255,   1075,   -255}, 0, { -9228,  -1054}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -255,   1075,    256}, 0, {-11272,  -1054}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   256,   1075,    256}, 0, {-11272,    990}, {0x2a, 0x2a, 0x2a,  0xff}}},
};

// 0x070066C0 - 0x07006780
static const Vtx wf_seg7_vertex_070066C0[] = {
    {{{   256,   1075,    256}, 0, {  3034,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   256,      0,   -255}, 0, {  5078,   4258}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   256,   1075,   -255}, 0, {  5078,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   256,      0,    256}, 0, {  3034,   4258}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -255,   1075,    256}, 0, { -1052,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   256,      0,    256}, 0, {   990,   4258}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   256,   1075,    256}, 0, {   990,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -255,      0,    256}, 0, { -1052,   4258}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   256,   1075,   -255}, 0, { -1052,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -255,      0,   -255}, 0, {   990,   4258}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{  -255,   1075,   -255}, 0, {   990,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{   256,      0,   -255}, 0, { -1052,   4258}, {0x2b, 0x2b, 0x2b,  0xff}}},
};
