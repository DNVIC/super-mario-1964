...
static const Vtx wf_seg7_vertex_0700F238[] = {
    {{{     0,    384,   -378}, 0, { 10188,   8162}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{  -168,    384,   -378}, 0, {  9514,   8162}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{     0,    384,    128}, 0, { 10188,  10186}, {0x2a, 0x2a, 0x2a,  0xff}}},
};

// 0x0700F268 - 0x0700F2C8
static const Vtx wf_seg7_vertex_0700F268[] = {
    {{{     0,   -383,    128}, 0, {  1080,   3032}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{     0,    384,    128}, 0, {  1080,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{  -168,    384,   -378}, 0, { -1052,      0}, {0x3b, 0x3b, 0x3b,  0xff}}},
    {{{     0,    384,   -378}, 0, {  1992,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{     0,    384,    128}, 0, {     0,      0}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{     0,   -383,    128}, 0, {     0,   3032}, {0x2a, 0x2a, 0x2a,  0xff}}},
};
