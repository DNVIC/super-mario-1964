...
static const Vtx wf_seg7_vertex_0700F0A0[] = {
    {{{     0,    384,    128}, 0, { 16320,  10186}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{   184,    384,   -378}, 0, { 17056,   8162}, {0x2a, 0x2a, 0x2a,  0xff}}},
    {{{     0,    384,   -378}, 0, { 16320,   8162}, {0x2a, 0x2a, 0x2a,  0xff}}},
};

// 0x0700F0D0 - 0x0700F130
static const Vtx wf_seg7_vertex_0700F0D0[] = {
    {{{     0,   -383,    128}, 0, {   990,   3032}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{     0,    384,    128}, 0, {   990,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{     0,    384,   -378}, 0, { -1032,      0}, {0x2b, 0x2b, 0x2b,  0xff}}},
    {{{     0,   -383,    128}, 0, {     0,   3032}, {0x36, 0x36, 0x36,  0xff}}},
    {{{   184,    384,   -378}, 0, {  2122,      0}, {0x36, 0x36, 0x36,  0xff}}},
    {{{     0,    384,    128}, 0, {     0,      0}, {0x36, 0x36, 0x36,  0xff}}},
};
